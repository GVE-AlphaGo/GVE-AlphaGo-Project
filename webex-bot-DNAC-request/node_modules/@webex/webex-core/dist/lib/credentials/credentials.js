 ...
 * @class
 */
var Credentials = _webexPlugin2.default.extend((_dec = (0, _common.oneFlight)({ keyFactory: function keyFactory(scope) {
    return scope;
  ...
  extractOrgIdFromJWT: function extractOrgIdFromJWT() {
    ...
    var decodedJWT = _jsonwebtoken2.default.decode(token);
  ...
  refresh: function refresh() {
    ...
    if (this.config.jwtRefreshCallback) {
      return this.config.jwtRefreshCallback(this.webex).then(function (jwt) {
        return _this6.webex.authorization.requestAccessTokenFromJwt({ jwt: jwt });
      });
    }
