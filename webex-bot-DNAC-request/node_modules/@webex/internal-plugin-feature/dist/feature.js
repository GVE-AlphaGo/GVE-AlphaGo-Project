...
var Feature = _webexCore.WebexPlugin.extend({
  ...
  setFeature: function setFeature(keyType, key, value) {
    ...
    return this.request({
      ...
      return _this.webex.internal.device.features[keyType].add(res.body, { merge: true });
    });
  },
  ...
  setBundledFeatures: function setBundledFeatures(featureList) {
    ...
    return this.request({
      ...
      _this2.webex.internal.device.features.user.add(partitionedToggles[0], { merge: true });
      _this2.webex.internal.device.features.developer.add(partitionedToggles[1], { merge: true });
    });
  },
