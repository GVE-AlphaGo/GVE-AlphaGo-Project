...
var Authorization = _webexCore.WebexPlugin.extend((_dec = (0, _common.whileInFlight)('isAuthorizing'), _dec2 = (0, _common.whileInFlight)('isAuthorizing'), (_obj = {
  ...
  initialize: function initialize(attrs, options) {
    ...
    var ret = (0, _apply2.default)(_webexCore.WebexPlugin.prototype.initialize, this, [attrs, options]);
    ...
    process.nextTick(function () {
      _this.webex.credentials.set({ supertoken: tokenData });
      _this.ready = true;
    });
  ...
  initiateImplicitGrant: function initiateImplicitGrant(options) {
    ...
    this.webex.getWindow().location = this.webex.credentials.buildLoginUrl((0, _assign2.default)({ response_type: 'token' }, options));
  ...
  initiateAuthorizationCodeGrant: function initiateAuthorizationCodeGrant(options) {
    ...
    this.webex.getWindow().location = this.webex.credentials.buildLoginUrl((0, _assign2.default)({ response_type: 'code' }, options));
