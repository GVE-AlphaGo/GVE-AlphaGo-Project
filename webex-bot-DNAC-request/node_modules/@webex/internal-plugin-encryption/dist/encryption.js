...
var Encryption = _webexCore.WebexPlugin.extend({
  ...
  _fetchDownloadUrl: function _fetchDownloadUrl(scr, options) {
    ...
    var endpointUrl = _url2.default.parse(scr.loc);
